...
// Route::get('/document/{project}/{section}/{page}', [DocumentController::class, 'show'])->name('document.show');


Route::prefix('admin')->get('/register/{id}/{role_id}', [UserInvitedRegisterController::class, 'create'])
                ->middleware('guest')
                ->name('register');

Route::prefix('admin')->post('/register/{id}/{role_id}', [UserInvitedRegisterController::class, 'store'])
                ->middleware('guest');
