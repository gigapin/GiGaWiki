...
<div class="flex flex-col jusctify-center fade-out">

    <!-- Toast Notification Success-->
    @if($type == 'success')
        <div class="flex items-center bg-green-500 border-l-4 border-green-700 py-2 px-3 shadow-md mb-2" id="success-alert">
            <!-- icons -->
